  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      <div className="mx-auto max-w-[1400px] px-4 pt-6 pb-32 lg:px-6 lg:py-16 space-y-6">
        <header>
          <h1 className="text-3xl font-semibold tracking-tight">Community</h1>
          <p className="mt-2 text-sm text-neutral-400 italic">This is your corner of the community. Post about your current read, the character you have questionable feelings for, or whatever&apos;s keeping you up at 2am. That&apos;s exactly what this place is for!</p>
        </header>
