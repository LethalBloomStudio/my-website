    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 20px" }}>
      ...
      <section className="mt-6 rounded-xl border border-[rgba(120,120,120,0.45)] bg-[rgba(120,120,120,0.14)] p-6" style={{ marginTop: 28 }}>
        ...
        <p className="mt-3 text-xs text-neutral-500 leading-relaxed">
          Youth ages 13–17 without a linked parent account can subscribe independently at the standard $10/month rate from their own subscription page. All youth safety rules and content restrictions still apply.
        </p>
        ...
        <p className="mt-4 text-xs text-neutral-500 leading-relaxed">
          Removing a linked youth account ends the +$5/mo add-on charge if you were on the Unlimited tier. Your subscription returns to its standard rate. When a youth member turns 18, their account is automatically upgraded to a full adult profile and the parent link is removed.
        </p>
      </section>
