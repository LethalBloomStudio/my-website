...
export default async function PublicProfilePage(props: {
  ...
  const { data, error } = await supabaseAdmin()
    ...
    .select(
      "user_id, username, pen_name, avatar_url, banner_url, bio, writes_genres, writer_level, publishing_goals, feedback_areas, feedback_preference, is_public, highlighted_manuscript_id, social_tiktok, social_facebook, social_instagram, social_x, social_snapchat, social_threads, social_lemon8, social_goodreads"
    )
