-- Run-all SQL for Supabase SQL Editor
-- Source: supabase/schema.sql + supabase/manuscripts_permissions_and_covers.sql
...
-- Additional manuscript permissions and cover storage policies
